...
function setBotTheme(theme) {
  if (theme === 'default') {
    ...
    styles.button.backgroundColor = '#085186';
    styles.sendButton.backgroundColor = '#ff6900';
    styles.userMessage.backgroundColor = '#ff6900';
    styles.userMessage.color = '#ffffff';
    styles.botMessage.backgroundColor = '#ffffff';
    styles.botMessage.color = '#000000';
    messages.style.backgroundColor = '#f7f7f7';
    chatbotContainer.style.border = '2px solid #085186';
  }

  if (theme === 'orange') {
    styles.header.backgroundColor = '#f97316';
    styles.button.backgroundColor = '#f97316';
    styles.sendButton.backgroundColor = '#f97316';
    styles.userMessage.backgroundColor = '#f97316';
    styles.userMessage.color = '#ffffff';
    styles.botMessage.backgroundColor = '#ffffff';
    styles.botMessage.color = '#000000';
    messages.style.backgroundColor = '#fef2e8';
    chatbotContainer.style.border = '2px solid #f97316';
  }

  if (theme === 'green') {
    styles.header.backgroundColor = '#10b981';
    styles.button.backgroundColor = '#10b981';
    styles.sendButton.backgroundColor = '#10b981';
    styles.userMessage.backgroundColor = '#10b981';
    styles.userMessage.color = '#ffffff';
    styles.botMessage.backgroundColor = '#ffffff';
    styles.botMessage.color = '#000000';
    messages.style.backgroundColor = '#e8fdf3';
    chatbotContainer.style.border = '2px solid #10b981';
  }

  if (theme === 'dark') {
    styles.header.backgroundColor = '#1f2937';
    styles.button.backgroundColor = '#1f2937';
    styles.sendButton.backgroundColor = '#374151';
    styles.userMessage.backgroundColor = '#374151';
    styles.userMessage.color = '#ffffff';
    styles.botMessage.backgroundColor = '#111827';
    styles.botMessage.color = '#f9fafb';
    messages.style.backgroundColor = '#1e293b';
    chatbotContainer.style.border = '2px solid #1f2937';
  }

  // Apply style changes live
  chatbotBtn.style.backgroundColor = styles.button.backgroundColor;
  Object.assign(header.style, styles.header);
  Object.assign(sendBtn.style, styles.sendButton);
}
